...
class Client(commands.Bot):
    def __init__(self):
        ...
        self.coglist = ["commands.fun", "commands.wake","commands.RandomEvents", "commands.whitelist", "commands.misc", "commands.McStats", "commands.infos", "commands.chat_mirror", "commands.backup"]
